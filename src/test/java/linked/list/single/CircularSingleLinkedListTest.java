...
class CircularSingleLinkedListTest {
    ...
    public void shouldCreateEmptyList() {
        // when
        var list = new CircularSingleLinkedList<Integer>();
        // then
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldInsertValueWithSpecifiedLocation(CircularSingleLinkedList<Integer> list,
                                                       int location,
                                                       Integer value,
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnInsertingAtWrongLocation(CircularSingleLinkedList<Integer> list,
                                                               int location,
                                                               Integer value) {
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldReturnLocationForTheList(CircularSingleLinkedList<Integer> list,
                                               Integer value,
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnSearchingTheValueThatDoesNotPresentedInTheList(CircularSingleLinkedList<Integer> list,
                                                                                     Integer value) {
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldDeleteWithSpecifiedLocation(CircularSingleLinkedList<Integer> list,
                                                  int location,
                                                  String expectedListRepresentation) {
        // when
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnDeletingElementWithWrongLocation(CircularSingleLinkedList<Integer> list,
                                                                       int location) {
    ...
    public static <T> String getStringRepresentationOf(CircularSingleLinkedList<T> list) {
        var builder = new StringBuilder();
        list.visit(builder::append);
        return builder.toString();
    }

    public static <T> CircularSingleLinkedList<T> createList(T... array) {
        var list = new CircularSingleLinkedList<T>();
        for (T element : array) {
