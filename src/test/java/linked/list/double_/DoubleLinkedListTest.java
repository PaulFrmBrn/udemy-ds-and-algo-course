...
class DoubleLinkedListTest {
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldInsertValueWithSpecifiedLocation(DoubleLinkedList<Integer> list,
                                                       int location,
                                                       Integer value,
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnInsertingAtWrongLocation(DoubleLinkedList<Integer> list,
                                                               int location,
                                                               Integer value) {
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldReturnLocationForTheList(DoubleLinkedList<Integer> list,
                                               Integer value,
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnSearchingTheValueThatDoesNotPresentedInTheList(DoubleLinkedList<Integer> list,
                                                                                     Integer value) {
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldDeleteWithSpecifiedLocation(DoubleLinkedList<Integer> list,
                                                  int location,
                                                  String expectedListRepresentation) {
        // when
    ...
    @ParameterizedTest
    @MethodSource
    public void shouldRaiseExceptionOnDeletingElementWithWrongLocation(DoubleLinkedList<Integer> list,
                                                                       int location) {
    ...
    public static <T> String getStringRepresentationOf(DoubleLinkedList<T> list) {
        var builder = new StringBuilder();
        list.visit(builder::append);
        return builder.toString();
    }

    public static <T> DoubleLinkedList<T> createList(T... array) {
